...
\begin{frame}{Ex falso quodlibet (2)}
    ...
    \begin{itemize}
        ...
        \item<3-> Peranto, possiamo affermare senza timori di smentita che in tutte le righe in cui le premesse sono contemporanamente vere, anche la conclusione $B$ è vera.
