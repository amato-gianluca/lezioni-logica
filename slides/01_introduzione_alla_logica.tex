...
\begin{frame}{Inferenze corrette e verità delle conclusioni}
	\medskip
	Ribadiamo che bisogna distinguere la correttezza della inferenze dalla verità della conclusione!
...
\begin{frame}{Ragionamento induttivo e abduttivo}
	...
	\uncover<4->{
	\begin{block}{Nota}
		Dal punto di visto deduttivo, queste inferenze non sono corrette. L'ultima, in particolare, è proprio quella che abbiamo chiamato ``fallacia dell'affermazione del conseguente''.
	\end{block}
	}
