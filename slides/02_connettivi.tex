...
\begin{frame}{Logica delle proposizioni}
    ...
    \begin{itemize}
        \item \prop{Carlo è ligure} afferma che un certo \emph{indiviuduo} (Carlo) gode di una certa proprietà (essere ligure).
...
\begin{frame}{Esempio di connettivo non vero-funzionale}
    ...
    \begin{itemize}
        \item \prop{Lucia ha mangiato una mela mentre \conn{mentre} ha guardato la televisione.}
    \end{itemize}
