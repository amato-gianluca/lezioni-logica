...
\begin{frame}{Implicazione e linguaggio naturale (3)}
    ...
    Ad ogni modo,
    \begin{itemize}
        \item nella logica, e quindi in tutto il resto del corso, tutte le volte in cui compare \conn{se \ldots allora} esso va interpretato come implicazione materiale;
