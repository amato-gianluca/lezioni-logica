...
\begin{itemize}
    ...
    \smallskip
    Questa regola corrisponde al \alert{ragionamento per casi}. Se so che $X \vee Y$, mi basta considerare separatamente i casi per cui vale $X$ e per cui vale $Y$ (sono le assunzioni da scaricare). Se in entrambi i casi riesco a dimostrare $Z$, allora $Z$ segue da $X \vee Y$.
\end{itemize}
\end{frame}
