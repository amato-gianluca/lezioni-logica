...
\begin{frame}{Dalla somma di bit alla somma di numeri (3)}
    Ad esempio, se abbiamo due numeri di 4 cifre ($A_3 A_2 A_1 A_0$ e $B_3 B_2 B_1 B_0$) un dispositivo che li somma si può ottenere come segue:
    \begin{center}
...
\begin{frame}{La legge di Moore}
    \centering
    \href{https://commons.wikimedia.org/wiki/File:Moore\%27s_Law_Transistor_Count_1970-2020.png}{\includegraphics[height=0.85\textheight]{img/Moore's_Law_Transistor_Count_1970-2020.png}}
\end{frame}
\end{document}