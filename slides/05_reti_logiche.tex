...
\begin{frame}{Dalla somma di bit alla somma di numeri (1)}
    ...
    \begin{center}
        \includegraphics[height=0.3\textheight]{img/1-bit_full-adder.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{Dalla somma di bit alla somma di numeri (3)}
    ...
    \begin{center}
        \includegraphics[height=0.3\textheight]{img/4-bit_adder.png}
    \end{center}
...
\begin{frame}{Il connettivo AND}
    ...
    \begin{center}
        \includegraphics[height=0.45\textheight]{img/TransistorANDgate.png}
    \end{center}
    \begin{itemize}
...
\begin{frame}{La legge di Moore}
    \centering
    \includegraphics[height=0.85\textheight]{img/Moore's_Law_Transistor_Count_1970-2020.png}
\end{frame}
\end{document}